...
conda activate /leonardo_scratch/large/userexternal/gpuccett/Repos/control_mgt/conda_venv
module load gcc

srun python /leonardo_scratch/large/userexternal/gpuccett/Repos/control_mgt/generation_code/generate_article_eng_xsum.py \
    --model_name llama-3.1-8b-instruct-hf --informed --temperature 0.8 --linguistic
